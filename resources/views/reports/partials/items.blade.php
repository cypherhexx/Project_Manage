@section('title', __('form.items') . " : ". __('form.report'))
<h6>@lang('form.items')</h6>
<small class="form-text text-info">@lang('form.item_report_note_1')</small>
<hr>
...
<table class="table dataTable no-footer dtr-inline collapsed" width="100%" id="data">
    <thead>
        <tr>
            ...
            <th>@lang("form.quantity_sold")</th>
            <th>@lang("form.total_amount")</th>
            <th>@lang("form.average_price")</th>                   
        </tr>
    </thead>
</table>
