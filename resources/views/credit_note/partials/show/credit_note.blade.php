<div style="font-size: 13px;">
   <div class="row">
      <div class="col-md-6 col-sm-6">
         <h4 class="bold">
            <a href="{{ route('edit_credit_note_page', $rec->id) }}">
            <span id="credit_note-number">{{ $rec->number }}</span>
            </a>
         </h4>
         <address>
         ...
         <p class="no-mbot">
            <span class="bold">
            @lang('form.credit_note_date'):  {{ $rec->date }}
            </span>
         </p>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="table-responsive">
            <table class="table items credit_note-items-preview">
               <thead>
                  <tr>
                     <th>#</th>
