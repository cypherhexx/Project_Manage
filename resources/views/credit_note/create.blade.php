...
@section('title', (isset($rec->id)) ? __('form.edit_credit_note') : __('form.create_new_credit_note'))
@section('content')
    <div id="sales">
    <form method="post" action="{{ (isset($rec->id)) ? route( 'patch_credit_note', $rec->id) : route('post_credit_note') }}">
        ...
        @include('credit_note.partials.general')
        @include('generic.items')
        @include('credit_note.partials.notes')
