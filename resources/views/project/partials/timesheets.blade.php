        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="timeSheetModalForm" action="" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>@lang('form.task') <span class="required">*</span></label>
                            <?php
                            echo form_dropdown('task_id', $rec->open_tasks_as_dropdown() , '', "class='form-control form-control-sm  selectpicker'");
                            ?>
                            <div class="invalid-feedback d-block task_id"></div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>@lang('form.member') <span class="required">*</span></label>
                            <?php
                            echo form_dropdown('user_id', $rec->members_as_dropdown() , '', "class='form-control form-control-sm  selectPickerWithoutSearch'");
                            ?>
