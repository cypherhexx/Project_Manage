      ...
      <div class="row">
        ...
        <div class="col-md-6">
           ...
           <div class="float-md-right">
               <a href="{{ route('download_proposal', $rec->id) }}" class="btn btn-light"><i class="far fa-file-pdf"></i> @lang('form.download')</a>

                @if($rec->status_id == PROPOSAL_STATUS_SENT || $rec->status_id == PROPOSAL_STATUS_OPEN)
    ...
    <div class="row">
      <div class="col-md-12"><hr></div>
        ...
        <div class="col-md-4">
            ...
            <h6><i class="far fa-file-alt"></i> @lang('form.summary')</h6>
            ...
            <br>
            <h6>@lang('form.proposal_information')</h6>
            ...
            <br><br>
            <h4>@lang('form.total') {{ format_currency($rec->total , TRUE, $rec->get_currency_symbol() ) }}</h4>
            <br><br>
            <div class="row">
                <div class="col-md-8">
                    <table style="width: 100%; font-size: 13px;">
                        <tr>
                            ...
                            <td class="text-right">{{ $rec->status->name }}</td>
                        </tr>
                        <tr>
                            <td>@lang('form.date')</td>
                            <td class="text-right">{{ sql2date($rec->date) }}</td>
                        </tr>
                        <tr>
                            <td>@lang('form.open_till')</td>
                            <td class="text-right">{{ sql2date($rec->open_till) }}</td>
                        </tr>
...
<form id="decline_form" action="{{ route('decline_proposal', $rec->id) }}" method="POST">
    {{ csrf_field()  }}
</form>    
...
<script type="text/javascript">
    ...
    $(function(){
            ...
            else
            {
                  signature_value = signaturePad.removeBlanks();
                    ...
                    $(submitButtonContext).html("{{ __('form.please_wait') }}").prop('disabled', true); 
                        $.post( "{{ route('accept_proposal', $rec->id )}}" , postData )
        ...
        @if(Session::has('proposal_flash_message'))
