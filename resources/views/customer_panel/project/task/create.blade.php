...
@section('content')
    ...
    <div class="main-content">
        ...
        <form method="post" action="{{ (isset($rec->id)) ? route( 'patch_task', $rec->id) : route('post_task') }}">
...
@section('onPageJs')
    <script>
        $(function () {
            ...
            <?php if(isset($rec->milestone_id) && $rec->milestone_id) { ?>
            ...
            parent_task_id.select2( {
                ...
                ajax: {
                    url: '{{ (isset($rec->id)) ? route("get_parent_tasks", [NULL, NULL, $rec->id]) : route("get_parent_tasks") }}',
